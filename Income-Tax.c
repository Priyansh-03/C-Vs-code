...
int main()
{
    float salary, nps_contribution, gis, lic, nsc, ppf, others1, others2, home_loan_principal, total_savings, total_rebate, taxable_income, income_tax, edu_health_cess, total_income_tax;
    ...
    total_savings = nps_contribution + gis + lic + nsc + ppf + others1 + others2 + home_loan_principal;
